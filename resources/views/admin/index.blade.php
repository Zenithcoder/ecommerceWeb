                        ...
                        <section class="vbox">
                            <section class="scrollable padder">
                                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                                    ...
                                    <li class="active">Delizia Foods</li>
                                </ul>
                                <div class="m-b-md">
                                ...
                                <section class="panel panel-default">
                                    <div class="row m-l-none m-r-none bg-light lter">
                                        <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                                            ...
                                            <a class="clear" href="#"> <span class="h3 block m-t-xs"><strong>{{$tuser->count()}}</strong></span> <small class="text-muted text-uc">Users</small> </a>
                                        </div>
                                        <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                                            ...
                                            <a class="clear" href="#"> <span class="h3 block m-t-xs"><strong id="bugs">200</strong></span> <small class="text-muted text-uc">ios users<br></small> </a>
                                        </div>
                                        <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                                            <span class="fa-stack fa-2x pull-left m-r-sm">
                                            ...
                                            <a class="clear" href="#"> <span class="h3 block m-t-xs"><strong id="firers">151</strong></span> <small class="text-muted text-uc">windows users</small> </a>
                                        </div>
                                        <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                                            <span class="fa-stack fa-2x pull-left m-r-sm">
                                            ...
                                            <a class="clear" href="#"> <span class="h3 block m-t-xs"><strong>{{$td->count()}}</strong></span> <small class="text-muted text-uc">Undelivered Order</small> </a>
                                        </div>
                                    </div>
                                </section>
                                <div class="row">
